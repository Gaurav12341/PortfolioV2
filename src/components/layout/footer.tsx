  ...
  return (
    <footer className="relative w-full overflow-hidden border-t pt-20 md:pt-32 pb-10">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 gap-12 border-t border-border/40 pt-12 md:grid-cols-12 md:gap-6">
          ...
          >
            ...
            <p className="max-w-xs text-muted-foreground text-sm leading-relaxed">
              Backend Software Engineer building distributed systems and cloud
              platforms, with hands-on experience shipping production AI/RAG
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              <SocialLink
                href="https://github.com/Gaurav12341"
                icon={FaGithub}
                label="GitHub"
              />
              <SocialLink
              ...
              />
              <SocialLink
                href="https://leetcode.com/u/Gaurav2706/"
                icon={SiLeetcode}
                label="LeetCode"
              />
            </div>
        ...
        >
          <p>© {currentYear} Gaurav Raj. All rights reserved.</p>
