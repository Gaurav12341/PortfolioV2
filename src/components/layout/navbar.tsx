...
import { PhoneReveal } from "@/components/common/phone-reveal";

const navLinks = [
  { name: "Projects", href: "#projects", label: "My Work" },
...
const socialLinks = [
  { name: "GitHub", href: "https://github.com/Gaurav12341" },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/gaurav-raj-405a96237/",
  },
  { name: "LeetCode", href: "https://leetcode.com/u/Gaurav2706/" },
];
              ...
              <div className="flex flex-col md:flex-row flex-1 gap-8 md:gap-0">
                ...
                >
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <PhoneReveal className="text-left text-sm text-muted-foreground hover:text-primary transition-colors cursor-pointer w-fit" />
                  </div>
