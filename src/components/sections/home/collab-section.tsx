      ...
      >
        ...
        <div className="relative flex flex-row w-full h-auto  md:h-screen items-stretch">
          ...
          >
            ...
            {/* Center text - pairs with the "You" baked into bg/2.png on the right */}
            <AnimatePresence>
              {animationComplete && (
                <motion.div
                ...
                >
                  <div className="max-w-xs text-center">
                    ...
                    <p className="mt-3 text-sm md:text-base text-white/70 leading-relaxed">
                      A backend engineer who solves the problem in front of
                      them — distributed systems, cloud platforms, and AI
                      features that ship to production.
                    </p>
                  </div>
                </motion.div>
              )}
          ...
          >
            ...
            {/* "You" itself is baked into bg/2.png — only add the paragraph
                below it, positioned to clear the baked-in heading */}
            <AnimatePresence>
              {animationComplete && (
                <motion.div
                  className="absolute inset-0 flex items-center justify-center z-30 pointer-events-none px-8"
                ...
                >
                  <div className="max-w-xs pt-32 text-center md:pt-40">
                    <p className="text-sm md:text-base text-white/70 leading-relaxed">
                      Someone looking to collaborate, or with a problem that
                      needs solving. Either way, let&apos;s talk.
                    </p>
                  </div>
                </motion.div>
              )}
