        ...
        <div ref={textRef} className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute inset-y-0 left-0 flex w-full flex-col justify-center px-6 sm:w-[55%] sm:px-14 lg:px-20">
            <div className="relative max-w-xl p-8 sm:p-10">
              ...
              >
                ~2 years building backend systems and cloud platforms at
                Honeywell — plus hands-on experience shipping production
                AI/RAG systems on top of them. Built on one simple rule: ship
                something measurable, and defend it.
              </p>
              ...
              >
                {["BACKEND", "DISTRIBUTED SYSTEMS", "CLOUD", "APPLIED AI"].map(
                  (discipline, i) => (
                    <span
                      key={discipline}
