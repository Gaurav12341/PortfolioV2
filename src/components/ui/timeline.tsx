...
export const Timeline = ({
  data,
  badge = "Gallery",
  headingLine1 = "The   Gallery",
  headingLine2 = "Showcase",
  subtitle = "Transforming ideas into engaging digital content designed to stand out.",
}: TimelineProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <PhraseAnimation phrase={subtitle} />
        </motion.div>
      </div>
